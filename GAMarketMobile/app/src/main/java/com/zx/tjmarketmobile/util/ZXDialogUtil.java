...
//            buider.setNegativeButton("取消", null);
    ...
    public static Dialog showCustomViewDialog(Context context, String title, View view, @Nullable DialogInterface.OnClickListener yesListener) {
        return showCustomViewDialog(context, title, view, yesListener, "确定", null, "取消", false);
    }
     ...
     * @param yesListener 确定按钮的点击事件
     */
    public static Dialog showCustomViewDialog(Context context, String title, View view, @Nullable DialogInterface.OnClickListener yesListener, String yesBtnText) {
        return showCustomViewDialog(context, title, view, yesListener, yesBtnText, null, "取消", false);
    }
    ...
    public static Dialog showCustomViewDialog(Context context, String title, View view, @Nullable DialogInterface.OnClickListener yesListener, boolean canceledOnTouchOutSide) {
        return showCustomViewDialog(context, title, view, yesListener, "确定", null, "取消", canceledOnTouchOutSide);
    }
    ...
    public static Dialog showCustomViewDialog(Context context, String title, View view, @Nullable DialogInterface.OnClickListener yesListener, DialogInterface.OnClickListener noListener) {
        return showCustomViewDialog(context, title, view, yesListener, "确定", noListener, "取消", false);
    }

    public static Dialog showCustomViewDialog(Context context, String title, View view, @Nullable final DialogInterface.OnClickListener yesListener, String yesBtnText, DialogInterface.OnClickListener noListener, String noBtnText, boolean canceledOnTouchOutSide) {
        AlertDialog.Builder buider = new AlertDialog.Builder(context);
        buider.setTitle(title);
        ...
        AlertDialog dialog = buider.show();
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                yesListener.onClick(null, 0);
            }
        });
        dialog.setCanceledOnTouchOutside(canceledOnTouchOutSide);
        dialogList.add(dialog);
