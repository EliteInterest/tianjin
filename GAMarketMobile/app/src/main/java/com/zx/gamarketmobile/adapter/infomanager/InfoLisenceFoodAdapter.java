...
public class InfoLisenceFoodAdapter extends MyRecycleAdapter {
    ...
    public InfoLisenceFoodAdapter.Holder myHolder;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_TYPE_NORMAL) {
            ...
            return new InfoLisenceFoodAdapter.Holder(view);
        } else {//footer
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof InfoLisenceFoodAdapter.Holder) {
            myHolder = (InfoLisenceFoodAdapter.Holder) holder;
            ...
            myHolder.tvStage.setText(entity.getLevel());
        } else {
