 ...
 * 功能：案件详情适配器
 */
public class InfoManagerDeviceDetailAdapter extends MyRecycleAdapter {
    private List<KeyValueInfo> dataList;
    private Context mContext;

    public InfoManagerDeviceDetailAdapter(Context c, List<KeyValueInfo> complainList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new InfoManagerDeviceDetailAdapter.Holder(view);
    }

    //从holder中获取控件并设置
    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        InfoManagerDeviceDetailAdapter.Holder myHolder = (InfoManagerDeviceDetailAdapter.Holder) holder;
