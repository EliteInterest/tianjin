package com.zx.gamarketmobile.ui.statistics;
...
import com.zx.gamarketmobile.adapter.ChartTableAdapter;
...
import com.zx.gamarketmobile.listener.IChartListener;
import com.zx.gamarketmobile.ui.base.BaseActivity;
import com.zx.gamarketmobile.util.ChartUtil;
import com.zx.gamarketmobile.util.DigitUtil;
import com.zx.gamarketmobile.util.DrawChartUtil;
...
public class ChartActivity extends BaseActivity implements IChartListener {
    ...
    private ApiData superTast = new ApiData(ApiData.HTTP_ID_statistics_super_countTask);
    private ApiData superType = new ApiData(ApiData.HTTP_ID_statistics_super_countType);
    ...
    private void initView() {
        ...
        superTast.setLoadingListener(this);
        superType.setLoadingListener(this);
        ...
        mQueryTypeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                tv.setTextColor(getResources().getColor(R.color.darkgrey));    //设置颜色
