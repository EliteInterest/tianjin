package com.zx.gamarketmobile.zoom;
				...
				Picasso.with(context).load(path).into(view, new Callback() {
					...
					public void onSuccess() {
						...
						if (bmp != null) {
							...
							bmp = ((BitmapDrawable) context.getResources().getDrawable(R.mipmap.pictures_no)).getBitmap();
							bitmap = bmp;
						}
					}
					@Override
					public void onError() {
						bitmap = ((BitmapDrawable) context.getResources().getDrawable(R.mipmap.pictures_no)).getBitmap();
					}
				});
			}
		}else{
