...
import com.zx.tjmarketmobile.view.ViewHolder;

import java.util.LinkedList;
import java.util.List;

public class PhoteSelectAdapter extends CommonAdapter<String>
{
	...
	public PhoteSelectAdapter(Context context, List<String> mDatas, int itemLayoutId,
                              String dirPath)
	{
