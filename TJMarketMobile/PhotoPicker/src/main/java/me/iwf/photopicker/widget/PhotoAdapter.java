...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.PhotoViewHolder> {
    ...
    public PhotoAdapter(Context mContext, ArrayList<String> photoPaths, String photoViewId) {
    ...
    public PhotoAdapter(Context mContext, ArrayList<String> photoPaths, OnDeleteListener deleteListener, String photoViewId) {
        this.photoPaths = photoPaths;
        this.mContext = mContext;
                ...
                holder.ivPhoto.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (photoPaths != null && photoPaths.size() >= maxNum) {
                            ...
                            PhotoPickUtils.startPick((Activity) mContext, false, maxNum, photoPaths,photoViewId);
                        }
                    }
                });
                ...
                holder.ivPhoto.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        PhotoPreview.builder()
                                ...
                                .setPhotoViewId(photoViewId)
                                .setAction(action)
                                .setShowDeleteButton(deleteListener == null)
