...
public class MultiPickResultView extends FrameLayout {
    ...
    public MultiPickResultView setMaxPicNum(int maxNum) {
    ...
    public MultiPickResultView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        photoViewId = UUID.randomUUID().toString();
    }
...
//        }
        photoAdapter = new PhotoAdapter(context, selectedPhotos, photoViewId);
        photoAdapter.maxNum = maxNum;
...
//            selectedPhotos.addAll(photos);
//        }
        photoAdapter = new PhotoAdapter(context, selectedPhotos, deleteListener, photoViewId);
        photoAdapter.maxNum = maxNum;
        photoAdapter.setAction(action);
        recyclerView.setAdapter(photoAdapter);
        //recyclerView.setLayoutFrozen(true);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (data==null||!photoViewId.equals(data.getStringExtra("id"))) {
            return;
        }
